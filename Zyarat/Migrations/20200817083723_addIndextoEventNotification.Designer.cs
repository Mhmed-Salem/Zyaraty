...
namespace Zyarat.Migrations
{
    ...
    [Migration("20200817083723_addIndextoEventNotification")]
    partial class addIndextoEventNotification
    {
            ...
            modelBuilder.Entity("Zyarat.Data.NotificationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Type = 0,
                            Template = "{UserName} makes a {like/dislike} to your comment in Dr/{doctorName}  {visit} "
                        },
                        new
                        {
                            Type = 1,
