...
{
    public partial class ModifyOnEndingProcs101 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE PROCEDURE OnEndingDailyCompetition
AS 
...
SELECT X.Ranking,X.CompetitionId,X.CompetitionId FROM #Competitors AS X;");
            migrationBuilder.Sql(@"CREATE PROCEDURE OnEndingMonthlyCompetition
AS 
